...
const services: Service[] = [
  ...
  {
    id: 2,
    title: "I will create a modern minimalist logo for your brand",
    provider: {
      name: "Noor Ahmed",
      image:
    ...
    tags: ["Minimalist", "Modern", "Logo Design"]
  },
  {
    id: 3,
    title: "I will design a creative and unique logo for your startup",
    provider: {
      name: "Alex Johnson",
      image:
    ...
    hasVideoConsultation: true,
    tags: ["Creative", "Startup", "Logo Design"]
  },
  {
    id: 4,
    title: "I will create a vintage and retro style logo for your brand",
    provider: {
      name: "Sarah Chen",
      image:
    ...
    hasVideoConsultation: false,
    tags: ["Vintage", "Retro", "Logo Design"]
  },
  {
    id: 5,
    title: "I will design a luxury and premium logo for your business",
    provider: {
    ...
    hasVideoConsultation: true,
    tags: ["Luxury", "Premium", "Logo Design"]
  },
  {
    id: 6,
    title: "I will create a playful and fun logo for your brand",
    provider: {
      name: "Emma Wilson",
      image:
    ...
    hasVideoConsultation: false,
    tags: ["Playful", "Fun", "Logo Design"]
  },
  {
    id: 7,
    title: "I will design a tech and modern logo for your startup",
    provider: {
      name: "David Kim",
      image:
  ...
  {
    id: 8,
    title: "I will create a hand-drawn and artistic logo for your brand",
    provider: {
      name: "Lisa Thompson",
      image:
    ...
    image:
      "https://images.unsplash.com/photo-1460925895917-afdab827c52f?q=80&w=500&h=300",
    hasVideoConsultation: false,
    tags: ["Hand-drawn", "Artistic", "Logo Design"]
  },
  {
    id: 9,
    title: "I will design a 3D logo for your brand",
    provider: {
      name: "James Wilson",
      image:
        "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?q=80&w=100&h=100",
    ...
    image:
      "https://images.unsplash.com/photo-1517292987719-0369a794ec0f?q=80&w=500&h=300",
    hasVideoConsultation: true,
    tags: ["3D", "Logo Design", "Modern"]
  },
  {
    id: 10,
    title: "I will create a mascot logo for your brand",
    provider: {
    ...
    image:
      "https://images.unsplash.com/photo-1558655146-9f40138edfeb?q=80&w=500&h=300",
    hasVideoConsultation: true,
    tags: ["Mascot", "Character", "Logo Design"]
  },
  {
    id: 11,
    title: "I will design a monogram logo for your business",
    provider: {
      name: "Robert Taylor",
      image:
        "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?q=80&w=100&h=100",
    ...
    image:
      "https://images.unsplash.com/photo-1467232004584-a241de8bcf5d?q=80&w=500&h=300",
    hasVideoConsultation: false,
    tags: ["Monogram", "Typography", "Logo Design"]
  },
  {
    id: 12,
    title: "I will create a wordmark logo for your brand",
    provider: {
      name: "Olivia Brown",
      image:
        "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?q=80&w=100&h=100",
    ...
    image:
      "https://images.unsplash.com/photo-1460925895917-afdab827c52f?q=80&w=500&h=300",
    hasVideoConsultation: true,
    tags: ["Wordmark", "Typography", "Logo Design"]
  }
];
          ...
          <div className="container mx-auto px-4 py-16 md:py-24 relative z-20">
            <div
              ...
              <p className="text-xl text-gray-300 mb-8">
                Find the perfect logo designer to create a unique and memorable
              ...
              <div className="relative max-w-2xl">
                <input
                  type="text"
                  placeholder="Search for logo design services..."
        ...
        <div className="container mx-auto px-4 py-12 ">
          <div className="flex justify-between items-center mb-8">
            <h2 className="text-2xl font-semibold text-white">
              {filteredServices.length} Premium Logo Design Services
            </h2>
